...
// in task_weather_app/test/home_page_temperathure_test.dart.
...
import 'package:task_weather_app/data/weather_data.dart' as _i2;
import 'package:task_weather_app/repository/weather_repo.dart' as _i3;
...
class MockWeatherRepository extends _i1.Mock implements _i3.WeatherRepository {
  ...
  @override
  _i5.Future<_i2.WeatherData> fetchWeatherData(
    String? cityName,
    _i6.Client? client,
  ) =>
      (super.noSuchMethod(
